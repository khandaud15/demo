          ...
          {loginSuccess ? (
            ...
            <>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6">
                  {/* Google Login Button - Import GoogleLogin from @react-oauth/google */}
                  <div className="flex justify-center">
                    <button
                      onClick={() => console.log("Google Sign-In should be here")}
                      className="flex items-center justify-center w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
